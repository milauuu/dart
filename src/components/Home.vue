...
boxSizing: 'border-box'
    ...
    <header style="text-align: center;">
        <h1 style="font-weight: 900; font-style: italic; font-size: 2.25rem; margin: 0; letter-spacing: -0.05em;">
        <span style="color: #FFCAD3;">JAY</span> DARTS
        </h1>
        <div style="height: 4px; width: 32px; background: #FFCAD3; margin: 0.5rem auto; border-radius: 4px; box-shadow: 0 0 12px #FFCAD3;"/>
    </header>

    <section style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
        <div style="display: flex; flex-direction: column;">
            <label style="font-size: 0.7rem; font-weight: 800; color: #71717a; text-transform: uppercase; margin-bottom: 0.5rem; padding-left: 0.5rem;">
                Points
            </label>
            <div style="background: rgba(16, 185, 129, 0.05); border: 2px solid #EB4574; border-radius: 20px; padding: 1.5rem 0; text-align: center; font-size: 1.75rem; font-weight: 900; color: white;">
                501
            </div>
        </div>
        <div style="display: flex; flex-direction: column;">
            <label style="font-size: 0.7rem; font-weight: 800; color: #71717a; text-transform: uppercase; margin-bottom: 0.5rem; padding-left: 0.5rem;">Finish</label>
            <div style="background: rgba(16, 185, 129, 0.05); border: 2px solid #EB4574; border-radius: 20px; padding: 1.5rem 0; text-align: center; font-size: 1.75rem; font-weight: 900; color: white;">
                DOUBLE OUT
            </div>
        </div>
    ...
    <section style="flex: 1; display: flex; flex-direction: column;">
        ...
        <h2 style="font-size: 0.8rem; font-weight: 800; color: #71717a; margin: 0;">ROSTER</h2>
        <span style="font-size: 0.7rem; font-weight: 900; color: #FFCAD3;">{{ selectedNames.length }} ACTIVE</span>
        </div>
        ...
        >
            ...
            <div @click="player.selected = !player.selected" :style="{
                width: '26px',
                height: '26px',
                borderRadius: '20%',
                border: '2px solid',
